...
# Mehrdad: Begin
from timm.models import resume_checkpoint,resume_checkpoint_state_dict
# Mehrdad: End
try:
...
def main():
    ...
    pruners = dgPruner.pruners_from_file('DG_Prune/lth_rigl_resnet50d.json')
